S.Heap = (function () {
    ...
    Heap.prototype.push = function (value, next) {
        ...
        console.log('Adding node with index %s', index);
        console.log('Available direction: %s', this.getAvailableDirection(index));
        console.log('Adding onto node: ');
        console.dir(this.getNodeByIndex(this.getParentIndex(index)));
